...
public class MutationPoolMenu extends AbstractContainerMenu {
    public final MutationPoolBlockEntity blockEntity;
    private final Level level;
    private ContainerData data;

    public MutationPoolMenu(int containerID, Inventory inv, FriendlyByteBuf extraData){
        this(containerID, inv, inv.player.level().getBlockEntity(extraData.readBlockPos()) , new SimpleContainerData(8));
    }
    public MutationPoolMenu(int containerID, Inventory inv, BlockEntity entity, ContainerData data){
        super(InfestusMenuTypes.MUTATION_POOL_MENU.get(), containerID);
        checkContainerSize(inv, 8);

        blockEntity = ((MutationPoolBlockEntity) entity);
    ...
    public boolean stillValid(Player pPlayer) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                pPlayer, InfestusBlocks.MUTATION_POOL.get());
    }
}
