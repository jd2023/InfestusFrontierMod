    ...
    public static final RegistryObject<CreativeModeTab> INFESTUS_TAB = CREATIVE_MODE_TABS.register("infestusfrontier",
            () -> CreativeModeTab.builder()
                    ...
                    .displayItems((pParameters, pOutput) -> {
                        ...
                        pOutput.accept(InfestusBlocks.ADVANCE_CORRUPTED_BLOCK.get());
                        pOutput.accept(InfestusBlocks.FINAL_CORRUPTED_BLOCK.get());
                        ...
                        pOutput.accept(InfestusBlocks.COLLECTOR.get());
