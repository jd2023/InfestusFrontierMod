...
public class InfestusItemModelProvider extends ItemModelProvider {
    ...
    protected void registerModels() {
        ...
        trimmedArmorItem(InfestusItems.MEAT_BOOTS);
        trimmedArmorItem(InfestusItems.MEAT_CHESTPLATE);
        trimmedArmorItem(InfestusItems.MEAT_LEGGINGS);
        trimmedArmorItem(InfestusItems.MEAT_HELMET);

    }
    private void trimmedArmorItem(RegistryObject<Item> itemRegistryObject) {
        final String MOD_ID = InfestusFrontier.MODID; // Change this to your mod id
