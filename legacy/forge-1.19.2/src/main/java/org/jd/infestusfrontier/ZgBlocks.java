...
public class ZgBlocks {
    ...
    public static final RegistryObject<Block> BIOMASS_CRYSTAL = BLOCKS.register(BiomassCrystal.ID, BiomassCrystal::new);
    ...
    public static final RegistryObject<Block> LOOT_LEECH = BLOCKS.register(InfesusLootLeechBlock.ID, InfesusLootLeechBlock::new);
